...
//     if (email[0] !== 0 && email.lastIndexOf('.') - email.indexOf('@') > 2) {
//         return 'Адрес електронної пошти правельний'
//     } else {
//         return 'Адрес електронної пошти НЕ правельний'
//     }
// }
...
//     }
// ];
// let arrSortX = coursesArray.sort((a, b) => a.modules.length - b.modules.length);
// console.log(arrSortX);
